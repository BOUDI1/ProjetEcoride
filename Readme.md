...
| **Gestion de Projet** | **Trello** | Utilisation d'un **Kanban partagé** pour la planification et le suivi pour le back-end future . |
...
| **Git** | Outil de gestion de version | Configuré avec user.name BOUDI1 et user.email 147846204+BOUDI1@users.noreply.github.com . |
...
* **Validation Client :** Utilisation des attributs HTML5 (`required`, `pattern`) pour valider la force du **Mot de Passe Sécurisé** et le format des emails  avant l'envoi au serveur.
...
* **Contrôle d'Accès :** Mise en place d'un contrôle d'accès basé sur les rôles (RBAC) pour les rôles sensibles 
